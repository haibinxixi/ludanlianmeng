//需要引用别的js的时候，就加上如Env.require("cookie.js")，或Env.require("/common/cookie.js")
...
var envLastVer = '2014_11_17_17_06';
...
var Env = new function () {
    ...
    //依次放入要载入的文件
    this.pushNeedLoad = function (url, type) {
        var _absUrl = null;
        if (url.charAt(0) == '/')
            _absUrl = url;
        else
        ...
        object.type = typeof (type) == "undefined" ? this.getFileExt(_absUrl) : type;
